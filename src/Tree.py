...
class Tree(object):
    ...
    # this array keeps "all people in the family"
    peopleList = []

    # to determine children of the specific person
    childList = []

    # these arrays are used for printing calculating level of person
    list = []
    list1 = []
    list2 = []
    list3 = []
    ...
    # these arrays are used for "printing family tree" operations
    level0 =[]
    level1 = []
    level2 = []
    level3 = []
